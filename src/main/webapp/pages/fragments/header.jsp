...
<body >
	<div >
		<div id="header-name"><fmt:message key="title.name" /></div>
		<div class="header">
			<c:choose>
			...
			<c:otherwise>
				<form name="toProfile" method="GET" action="controller">
				...
				<form name="signoutForm" method="GET" action="controller">
				...
				<ul>
					<c:choose>
						<c:when test="${sessionScope.locale == 'en_US'}">
							<a class="header-link" href='<c:url value="/controller?command=change_locale&locale=ru_RU"/>' class="ru">
								<fmt:message key="button.language" /></a>
						</c:when>
						<c:otherwise>
							<a class="header-link" href='<c:url value="/controller?command=change_locale&locale=en_US"/>' class="en">
								<fmt:message key="button.language" /></a>
						</c:otherwise>
					</c:choose>
				</ul>
